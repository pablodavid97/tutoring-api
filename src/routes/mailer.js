  ...
  try {
    ...
    if (meeting.estadoId === 1) {
      ...
      messageStart =
        ...
        ' ' +
        professor.apellidos +
        ' te ha invitado a una reunión. Los detalles se muestran a continuación.';
      messageEnding =
        'Si necesitas mayor información comunicate con tu profesor.';
      ...
      messageStart =
        ...
        ' ' +
        professor.apellidos +
        ' editó una reunión en la que participabas. Los detalles se muestran a continuación.';
      messageEnding =
        'Si necesitas mayor información comunicate con tu profesor.';
      ...
      messageStart =
        ...
        ' ' +
        student.apellidos +
        ' aceptó la reunión. Los detalles se muestran a continuación.';
      messageEnding =
        'Planifica los temas a tratar en esta reunión antes de que se realice.';
      ...
      messageStart =
        ...
        ' ' +
        student.apellidos +
        ' rechazó la reunión que creaste. Los detalles se muestran a continuación.';
      messageEnding =
        'Ponte en contacto con ' +
        student.nombres +
        ' ' +
        student.apellidos +
        ' para reagendar la reunión.';
    } else if (meeting.estadoId === 5) {
      user = student;
      preHeader =
        'Tu profesor ha eliminado una reunión en la que participabas.';
      meetingSubject = 'USFQ Tutorías: Reunión Eliminada';
      messageStart =
        professor.nombres +
        ' ' +
        professor.apellidos +
        ' eliminó una reunión en la que participabas. Los detalles se muestran a continuación.';
      messageEnding =
        'Si necesitas mayor información comunicate con tu profesor.';
      ...
      messageStart =
        'Tienes una reunión fijada para el día de hoy. Los detalles se muestran a continuación.';
      messageEnding =
        'Ingresa a la plataforma para asistir a la reunión e incluir tus comentarios.';
      ...
      if (isProfessor) {
        user = professor;
        messageStart =
          'Indicaste que la reunión se realizó con exito. Los detalles se muestran a continuación.';
        messageEnding =
          'Si quieres agendar una nueva reunión ingresa a la plataforma.';
      } else if (isStudent) {
        user = student;
        messageStart =
          professor.nombres +
          ' ' +
          professor.apellidos +
          ' indicó que la reunión se realizó con exito. Los detalles se muestran a continuación';
        messageEnding =
          'Si tienes alguna duda sobre la información presentada comunicate con tu profesor.';
      }
      ...
      if (isProfessor) {
        user = professor;
        messageStart =
          'Indicaste que la reunión no se realizó. Los detalles se muestran a continuación.';
        messageEnding =
          'Si quieres agendar una nueva reunión ingresa a la plataforma.';
      } else if (isStudent) {
        user = student;
        messageStart =
          ...
          ' ' +
          professor.apellidos +
          ' indicó que la reunión no se realizó. Los detalles se muestran a continuación';
        messageEnding =
          'Si tienes alguna duda sobre la información presentada comunicate con tu profesor.';
      }
    }
